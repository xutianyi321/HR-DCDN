...
def main():
    ...
    train_data = HGDCGNDataset(train_set, u_items_list, u_users_list, i_users_list, i_items_list, user_count, item_count)
    valid_data = HGDCGNDataset(valid_set, u_items_list, u_users_list, i_users_list, i_items_list, user_count, item_count)
    test_data = HGDCGNDataset(test_set, u_items_list, u_users_list, i_users_list, i_items_list, user_count, item_count)
